	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="/express">Personal Authorization
					Information</a>
			</div>
		</div>
	</nav>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    <li>Code    : {{.Code}}<p>
                    <li>Method  : {{.Method}}<p>
                    <li>Message : <p class="text-warning">{{.Message}}</p>
                    <p><a class="btn btn-default" href="/express" role="button">Return &raquo;</a></p>
                </ul>
            </div>
            <div class="col-md-4">
